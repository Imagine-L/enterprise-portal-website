package top.liubaiblog.masterstudiofront.exception.handler;

import lombok.extern.slf4j.Slf4j;
import org.springframework.validation.BindException;
import org.springframework.web.bind.annotation.ControllerAdvice;
import org.springframework.web.bind.annotation.ExceptionHandler;
import top.liubaiblog.masterstudiofront.enums.ResponseDataEnum;
import top.liubaiblog.masterstudiofront.exception.param.RequestParamsException;
import top.liubaiblog.masterstudiofront.util.http.HttpResponseUtils;
...
public class GlobalExceptionHandler {
    ...
    public void requestParamsExceptionHandle(HttpServletResponse resp, Exception e) {
        printException(e);
        HttpResponseUtils.write(resp, ResponseDataBuilder
                .builder()
